...
?>
  ...
  <div class="row">
      <form class="form-horizontal" name="myForm" onsubmit="return validateForm()" action="<?php echo base_url();?>UserControl/insertregister" method="post">
       <font color="red"> <?php echo $this -> session->flashdata("status"); ?></font>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
          <input type="email" class="form-control" id="mail" oninput="myFunction()"  placeholder="Enter e-mail" name="mail"  data-validate="required,email" style="background-color:#5bc0de">  
                           <p id="demo"></p>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
          <input type="number" class="form-control" id="phone" oninput="phoneValidation()" style="background-color:#5bc0de" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter phone number" name="phone">
      <!-- <p id="phone"></p> -->
      </div>
    </div>
        <div class="form-group">
      ...
      <div class="col-sm-8">
          <input type="number" class="form-control" id="aphone" oninput="phoneValidation()" style="background-color:#5bc0de" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter alter phone number" name="aphone">
      <!-- <p id="phone"></p> -->
      </div>
    </div>       
	...
	<div class="form-group">
      ...
      <div class="col-sm-8">
          <input type="number" class="form-control" id="age" oninput="ageValidation()" onkeypress="if(this.value.length==2) return false" min="0" placeholder="Enter Age" name="age" >
      <p id="phone"></p>
      </div>
	</div>  
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
        <input type="date" class="form-control" id="Birth"  placeholder="Enter date" name="dat" >
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
        <input type="text" class="form-control" id="qua"  placeholder="Enter Qualification" style="background-color:#5bc0de" name="qua">
      </div>
	</div>
  ...
  <select class="form-control"  id="gen" name="gender" >
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
          <textarea class="form-control" id="add" placeholder="Enter Address" name="address" style="background-color:#5bc0de"></textarea>
      </div>
    </div>
