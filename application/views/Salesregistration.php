...
<br>
  ...
  <form class="form-horizontal" action="<?php echo base_url();?>Managementcontrol/salesregistration" method="post">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9"> 
        <textarea class="form-control" id="pwd" placeholder="Enter Your Address" name="uadd" required></textarea>
    </div>
  </div>
