    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <center>
        ...
        <?php echo form_open_multipart('ProjectControl/do_uploader');?>  
        <form method="post" >
            <table border="0">
                <tr>
                    <td>Name: </td>
...
<div class="container">
  ...
  <?php foreach($sliderlist as $item){?>
        ...
        <td><img src="<?php echo base_url().$item->IMGPATH; ?>" alt="<?php echo $item->IMGPATH; ?>" height="100" width="142">  </td>
