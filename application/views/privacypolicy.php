    ...
    <body>
        ...
        <div id="content" class="no-top">
            ...
            <div class="container" style="padding-top: 90px">
                <div class="row">
               <p> Live in Passion ("us", "we", or "our") operates the <a href="<?php echo base_url();?>">Liveinpassion</a> website (the "Service").
This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data. This Privacy Policy for Live in Passion is powered by FreePrivacyPolicy.com.
We use your data to provide and improve the Service. By using the Service, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible from http://www.liveinpassion.com/</p> <br>
...
Examples of Cookies we use:
    ...
    • Security Cookies. We use Security Cookies for security purposes.</p>
               ...
               <p>Live in Passion uses the collected data for various purposes:</p>
...
Live in Passion will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h1>Disclosure Of Data</h1>
<h3>Legal Requirements</h3>

Live in Passion may disclose your Personal Data in the good faith belief that such action is necessary to:
    • To comply with a legal obligation
    • To protect and defend the rights or property of Live in Passion
...
<p>You can opt-out of having made your activity on the Service available to Google Analytics by installing the Google Analytics opt-out browser add-on. The add-on prevents the Google Analytics JavaScript (ga.js, analytics.js, and dc.js) from sharing information with Google Analytics about visits activity.
For more information on the privacy practices of Google, please visit the Google Privacy & Terms web page: ><a href="https://policies.google.com/privacy?hl=en ">Google Privacy </a>  
...
<p>If you have any questions about this Privacy Policy, please contact us:
    • By email: http://www.liveinpassion.com/ </p>
