...
<section>
  ...
  <div class="row">
    <div class="col-sm-4">
      ...
      <h1><b>Admin Login</b></h1>
       ...
       <form action="<?php echo base_url(); ?>UserControl/loginCheckAdmin" method="post">
  ...
  <center> <font color="red"> <i><?php echo $this -> session->flashdata("user"); ?></i></font></center>
   ...
   <p><i> <a href="<?php echo base_url(); ?>UserControl/resetpassword" style="color:red;">Forgot Password</a></i>  </p>
