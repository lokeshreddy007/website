    ...
    */
    ...
    <center><h1 style='color:white' <b>Quatation FORM</b></h1></center>
        ...
        <?php foreach($button as $item){?>
            ...
            <?php $idlink = $item->userid;?>
            <?php echo $item->field7;?>
            <?php $valbutton = $item->field7;?>
       ...
       <button onclick="window.location.href='<?php echo base_url();?>Managementcontrol/Conformorder'" style="text-align: center;" type="button" class="btn btn-success">Next</button>
...
<div class="container" style="border-style: solid; border-width: 1px;border-radius: 15px;background-color:whitesmoke;">
    ...
    <div class="row">
                ...
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <form class="form-horizontal" action="<?php echo base_url();?>Managementcontrol/sendmail" method="post">
                           ...
                           ?> 
                                ...
                                <?php $comment = $item->comment;?>
                                  ...
                                  <?php }?>   
                                    ...
                                    <input type="hidden" value="<?php echo $work; ?>" name="work" />
                                 ...
                                 <input disabled id="form_email" name ="mail"   class="form-control" placeholder="Please enter your email *" required="required" data-error="Valid email is required." type="email" value="<?php echo $mail ?>">        
                                        ...
                                        <input disabled id="form_name"   style="background-color:#5bc0de" class="form-control" placeholder="Please enter your Name *" required="required" data-error="Name is required." type="text" value="<?php echo $phone ?>">
                                          ...
                                          <input type="number"  name="qua"  class="form-control" value="<?php echo $qua ?>"/>
                                          </br>
                                <label for="form_follow_up_date">Date*</label>
                                <input type="data" id="datepicker" class="form-control" value="<?php echo $dat ?>" style="background-color:#5bc0de" placeholder="Enter date" name="newdata" >
