...
//                                  echo $item->iduser;
		...
		<?php } ?>
            ...
            <form  action="<?php echo base_url();?>Managementcontrol/checkinstallment?id=<?php echo $id; ?>" method="post">
            
            
            
             <h1 style="text-align: center;"><b>PAYMENTS</b></h1>
            ...
            $intnum = NULL;
               ?>
                  <input type="hidden" value="<?php echo $intnum; ?>" name="intnum" />
        ...
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            ...
            <div class="col-xs-offset-6 ">
                 ...
                 <button type="submit" id="install" class="btn btn-primary">Installment</button>
                     ...
                     <input type="hidden" id ="instabrofornow"  name="instabro"  />
<input type="hidden" id ="datefornow"  name="date"  />
<input type="hidden" id ="nowfornow"  name="amountnow"  />
<input type="hidden" id ="desfornow"  name="desicri"  />
...
//            console.log(b);
            ...
            if(finalval == sum){
               ...
               console.log('this are the value .....');
               console.log(a);
               ...
               console.log(c);
               console.log(d);
               document.getElementById("nowfornow").value = a;
                document.getElementById("instabrofornow").value = b;
                document.getElementById("datefornow").value = c;
                document.getElementById("desfornow").value = d; 
                 return false;
