...
<?php } ?>
    ...
    <div class="container" style="border-style: solid; border-width: 1px;border-radius: 15px;background-color: white;">
        ...
        <h2 style="text-align: center;">Stock List Edit</h2>
        
  
  
  <div class="row">
      <form class="form-horizontal" name="myForm" onsubmit="return validateForm()" action="<?php echo base_url();?>Managementcontrol/updatestock" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
          <input type="text" class="form-control" id="myInput"  value="<?php echo $Material ?>"   placeholder="Enter Material" name="Material" style="background-color:#5bc0de" >  
      ...
      <div class="col-sm-8"> 
      <input type="number" class="form-control" id="pwd"  value="<?php echo $Quantity ?>" placeholder="Enter Tax" name="Quantity"  >     
      </label>           
      </div>
    </div>
   ...
   <div class="form-group">
      ...
      <div class="col-sm-8">          
        <input type="number" class="form-control" id="pwd"  value="<?php echo $Price ?>"  placeholder="Enter Price" name="Price" style="background-color:#5bc0de" >
      </div>
    </div>
      ...
      <div class="col-sm-8"> 
      <input type="number" class="form-control" id="pwd"  value="<?php echo $Tax ?>"  placeholder="Enter Tax" name="Tax"  >
      ...
      <div class="col-sm-8">          
          <textarea class="form-control" id="pwd"   placeholder="Enter Address" name="Address" style="background-color:#5bc0de"><?php echo $Address ?> </textarea>
      </div>
    </div>
      ...
      <div class="col-sm-8">
          <input type="number" class="form-control" value="<?php echo $Phone ?>" id="id-phone" oninput="phoneValidation()" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter phone number" name="Phone" style="background-color:#5bc0de">
      <p id="phone"></p>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
      <input type="text" class="form-control" id="pwd"  value="<?php echo $Vendor ?>"  placeholder="Enter Vendor" name="Vendor"  >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-4" for="pwd">Email*</label>
      <div class="col-sm-8">          
          <input type="email" class="form-control" id="mail"  value="<?php echo $Email ?>"  oninput="myFunction()" placeholder="Enter e-mail" name="Email"  data-validate="required,email"  style="background-color:#5bc0de">  
                           <p id="demo"></p>
      </div>
    </div>
    <div class="form-group">
      ...
      <div class="col-sm-8">          
      <input type="date" class="form-control"  value="<?php echo $Date ?>" placeholder="Enter date" name="Date" >
