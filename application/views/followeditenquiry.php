...
<html lang="en">
<head>
  <title>followEnquiryfromedit</title>
  <meta charset="utf-8">
...
<?php $id = intval($_GET['id']);?>
    ...
    <div class="Back">
        ...
        <button onclick="window.location.href='<?php echo base_url();?>Managementcontrol/followEnquirynextpage?id=<?php echo $id; ?>'" style="text-align: center;" type="button" class="btn btn-success">Next</button>
  ...
  <div class="row">
      <form class="form-horizontal" name="myForm" onsubmit="return validateForm()" action="<?php echo base_url();?>Managementcontrol/followeditenquiryf" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
        <input type="data" class="form-control" id="datepicker" value="<?php echo $dat ?>"  placeholder="Enter date" name="dat" >
  ...
  <!-- <input id="txtstartdate2"  class="form-control" placeholder="Enter Date" name="delivery" style="background-color:#5bc0de" />  -->
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
      <input type="data" class="form-control" id="datepicker3"  style="background-color:#5bc0de" placeholder="Enter date" name="hdate" value="<?php echo $hdate ?>" style="background-color:#5bc0de">
      
  <!-- <input id="txtstartdate3"  class="form-control" placeholder="Enter Date" style="background-color:#5bc0de" name="hdate"  />  -->
      </div>
    </div>
            <br>
     <div class="btn-group">
