...
<?php $id = intval($_GET['id']);?>
       ...
       <button onclick="window.location.href='<?php echo base_url();?>Managementcontrol/followup?id=<?php echo $id; ?>'" style="text-align: center;" type="button" class="btn btn-success">Next</button>
...
<div class="container" style="border-style: solid; border-width: 1px;border-radius: 15px;background-color:whitesmoke;">
 ...
 <form class="form-horizontal" action="<?php echo base_url();?>Managementcontrol/updatequatation?id=<?php echo $id; ?>" method="post">
                        ...
                        <div class="controls">
                           ...
                           ?> 
                                ...
                                <input type="data" id="datepicker" class="form-control"  style="background-color:#5bc0de"  placeholder="Enter date" name="newdata" >
