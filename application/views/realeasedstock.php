...
<div class="container">
 ...
 <?php {?>
      <?php }?>   
     <a href="<?php echo base_url();?>Managementcontrol/realesepdf"  class="btn btn-success">
...
<!--            <th>Due Amount</th>
         ...
         <tbody>
        <?php foreach ($real as $item){ ?>
  <tr>
    <td><a href="<?php echo base_url(); ?>Managementcontrol/showdueall?id=<?php echo $item->id; ?>" /> <?php echo $item->id; ?></td>
