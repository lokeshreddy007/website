...
<?php } ?>
   ...
   <?php } ?>
    ...
    <div class="container" style="border-style: solid; border-width: 1px;border-radius: 15px;background-color: white;">
        ...
        <h2 style="text-align: center;">Materials List Edit</h2>
        
  
  
  <div class="row">
      <form class="form-horizontal" name="myForm" onsubmit="return validateForm()" action="<?php echo base_url();?>Managementcontrol/updatematerial" method="post">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
        <input type="text" class="form-control" value="<?php echo $name ?>"    id="pwd" placeholder="Enter Material Name" style="background-color:#5bc0de" name="name">
      </div>
    </div>
     <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
        <input type="number" class="form-control" id="pwd"  value="<?php echo $num ?>" placeholder="Enter Vendor ID" name="num" style="background-color:#5bc0de" >
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-4" for="pwd">Vendar Name*</label>
      <div class="col-sm-8">          
        <input type="text" class="form-control" id="pwd" value="<?php echo $vname ?>"  placeholder="Enter Vendar Name"  name="vname">
      </div>
    </div>
         <div class="form-group">
      <label class="control-label col-sm-4" for="pwd">Description*</label>
      <div class="col-sm-8">          
          <textarea class="form-control" id="pwd" value=" <?php echo $item->des; ?>" placeholder="Enter Description" name="des"> <?php echo $item->des; ?></textarea>
      </div>
    </div>
         </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
          <input type="number" class="form-control" value="<?php echo $phone ?>" id="id-phone" oninput="phoneValidation()" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter phone number" name="phone">
      <p id="phone"></p>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
          <input type="email" class="form-control" id="myInput" value="<?php echo $mail ?>" oninput="myFunction()" placeholder="Enter e-mail" name="mail"  data-validate="required,email" style="background-color:#5bc0de">  
                           <p id="demo"></p>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
          <textarea class="form-control" id="pwd" placeholder="Enter Address" name="address"><?php echo $address ?></textarea>
      </div>
    </div>
  ...
  <button type="submit" style="margin:5px;" class="btn btn-primary">Submit</button>
   ...
   <!-- <button onclick="window.location.href='<?php echo base_url();?>Managementcontrol/EnqueryNextPage'" style="text-align: center;margin:5px;" type="button" class="btn btn-primary">Next</button> -->
    ...
    <input type="hidden" value=" <?php echo $idmt; ?>" name="id"/>
</form>
<!--<div id="mybutton1">
