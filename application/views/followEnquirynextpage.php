...
?>
   ...
   <?php echo $num[$val]; ?>
     ...
     <div class="Back">
       ...
       <button onclick="window.location.href='<?php echo base_url();?>Managementcontrol/followup'" style="text-align: center;" type="button" class="btn btn-success">Next</button>
    ...
    <fieldset>
        <div class="container">
            <div class="row">
  <form class="form-horizontal" name="myForm"  action="<?php echo base_url();?>Managementcontrol/InsertEnquirypagetwo" method="post">
