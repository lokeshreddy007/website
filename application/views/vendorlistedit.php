...
<?php } ?>
   ...
   <?php } ?>
    ...
    <div class="container" style="border-style: solid; border-width: 1px;border-radius: 15px;background-color: white;">
        ...
        <h2 style="text-align: center;">Vendor List Edit</h2>
        
  
  
  <div class="row">
      <form class="form-horizontal" name="myForm" onsubmit="return validateForm()" action="<?php echo base_url();?>Managementcontrol/updatevendor" method="post">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-8">
            ...
            <input type="text"   value="<?php echo $name ?>"  class="form-control" id="cname" placeholder="Enter name" name="name" required  ">
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
          <input type="email"  value="<?php echo $mail ?>"  class="form-control" id="myInput" oninput="myFunction()"  placeholder="Enter e-mail" name="mail"  data-validate="required,email" style="background-color:#5bc0de">  
                           <p id="demo"></p>
      </div>
    </div>
      ...
      <div class="col-sm-8">          
        <input type="data" id="datepicker" value="<?php echo $dat ?>"  class="form-control"   placeholder="Enter date" name="dat" >
      </div>
    </div>
      ...
      <div class="col-sm-8">          
          <textarea class="form-control"  id="pwd" placeholder="Enter comments" name="address" style="background-color:#5bc0de">  <?php echo $address ?> </textarea>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
          <input type="number"  value="<?php echo $num ?>"  class="form-control" id="id-phone" oninput="phoneValidation()" onkeypress="if(this.value.length==10) return false" min="0" placeholder="Enter phone number" name="num" >
      <p id="phone"></p>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
          <input type="number"  value="<?php echo $aphone ?>"  class="form-control" id="id-Aphone" oninput="AphoneValidation()" onkeypress="if(this.value.length==10) return false;" min="0"  placeholder="Enter alternate phone number" name="aphone"  style="background-color:#5bc0de ">
      <p id="Aphone"></p>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">          
      <input  class="form-control"  value="<?php echo $hdate ?>"  id="pwd" placeholder="Enter Material" name="hdate"  >
      </div>
    </div>
   <?php $idvregister = intval($_GET['id']);?>
      
    <input type="hidden" value="<?php echo $idvregister; ?>" name="id" />
    <input type="hidden" value="<?php echo $idvregister; ?>" name="idvregister" />
