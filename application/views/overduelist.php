...
<div class="container">
    <div class="Back">
        <INPUT TYPE="button" style="text-align: center" type="button" class="btn btn-success" VALUE="Back" onClick="history.go(-1);">
         <button onclick="window.location.href='<?php echo base_url();?>Managementcontrol/showoverduelist'" style="text-align: center;" type="button" class="btn btn-success">Next</button>
...
//    print_r($all);
    ...
    <tbody>
        <tr>
            <?php for($i=0;$i<$checkdue;$i++){ ?>
            <?php foreach ($view as $item) { ?>
              <?php if($item->iduser == $all[$i]) { ?>
 
     <td><a href="<?php echo base_url(); ?>Managementcontrol/showdueall?id=<?php echo $item->iduser; ?>" /> <?php echo $item->iduser; ?></td>
